...
export const reviewCommentList = [
  { id: "6d7abc69-524b-4a09-a5e4-9af87c6845a2", userId : "20083678-9A55-4C2B-BDD9-F71845EBE4B6", "프로필 이미지":
    "https://images.unsplash.com/photo-1708461646032-5743c250ac77?q=80&w=1935&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D", 이름: '김하나', 닉네임: '행복한 고양이', '작성 일자': '2024.09.24', '댓글단 모임': '소셜다이닝: 이상식탁', "후기 댓글": '부산 갈~매 기 붓싼 가아아아알~매 애애애기가아아아알~매', "삭제된 댓글" : false },
  { id: "963287f5-a169-4329-bd83-af579c276b97", userId: "775DD0B9-E338-4777-89D6-9FE6A7175806", "프로필 이미지":
    "https://images.unsplash.com/photo-1550133725-5fc2925431fa?q=80&w=1887&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D", 이름: '지현욱', 닉네임: '배우 지현욱 좋아요', '작성 일자': '2024.09.25', '댓글단 모임': '독서모임: 북페어링 (상시모집)', "후기 댓글": '졸라 못가르침, 와인이나 먹으러 다니고 쓰레기임 그 사람', "삭제된 댓글" : true, "삭제된 일자" : "2024.09.21" },
  { id: "4f724b74-5b3a-440e-ac68-b6029fc387bf", userId : '396C8AB1-9FC9-4B07-8E16-CFDBA6A22455', "프로필 이미지":
    "https://plus.unsplash.com/premium_photo-1676106623114-e2edc4f04fe0?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",  이름: '이준호', 닉네임: '커피 중독자', '작성 일자': '2024.09.20', '댓글단 모임': '사진출사모임 : 나를 기록하는 사진관 ', "후기 댓글": '제주도에서의 시간은 정말 최고였어요. 다시 가고 싶네요.', "삭제된 댓글" : false },
  { id: "6510fc78-f81d-4b39-9689-faa65d8f49a8", 이름: '이영애', 닉네임: '드라마퀸', '작성 일자': '2024.09.18', '댓글단 모임': '운동모임:정기산행 (상시모집)', "후기 댓글": '이 드라마는 다시 봐도 정말 눈물나네요.',"삭제된 댓글" : false },
  { id: "f6574663-f34b-4223-9f0d-7949f835e10b", 이름: '박보검', 닉네임: '보검홀릭', '작성 일자': '2024.09.17', '댓글단 모임': '운동모임 : 선셋 러닝 (상시모집)', "후기 댓글": '박보검나 재밌어.',"삭제된 댓글" : true, "삭제된 일자" : "2024.10.01" },
  { id: "7cad1f61-9dff-471b-a8c0-332a9155f822", 이름: '손흥민', 닉네임: '축구왕', '작성 일자': '2024.09.19', '댓글단 모임': '사진출사모임 : 나를 기록하는 사진관', "후기 댓글": '흥민이가 한 골 넣었을 때 정말 소름이 돋았어요.', "삭제된 댓글" : false },
  { id: "64fdc1a7-2f74-47f5-8187-6db45a44eb00", 이름: '류현진', 닉네임: '야구천재', '작성 일자': '2024.09.16', '댓글단 모임': '운동모임 : 선셋 러닝 (상시모집)', "후기 댓글": '메이저리그 경기는 언제 봐도 재미있네요.', "삭제된 댓글" : false },
  { id: "1b1eb551-c9f4-451f-9ea3-d7d4fe52124d", 이름: '김연아', 닉네임: '피겨여왕', '작성 일자': '2024.09.15', '댓글단 모임': '운동모임:정기산행 (상시모집)', "후기 댓글": '김연아 선수는 언제나 저의 영웅입니다.', "삭제된 댓글" : false },
];